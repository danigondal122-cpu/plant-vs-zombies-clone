...
oS.Init({
  ...
  ZName: [oZombie, oConeheadZombie, oBalloonZombie, oNewspaperZombie, oFootballZombie, oCrystal],
  PicArr: ["images/interface/ForestJx.webp"],
  backgroundImage: "images/interface/ForestJx.webp",
  LevelName: $__language_Array__["4953f9c276585025e728ac0fa001a01e"],
  LvlEName: 6,
  ...
  StartGame: function () {
    ...
    oSym.addTask(70, PlaceZombie, [oCrystal, 2, 7]);
    StopMusic();
  ...
  AZ: [[oZombie, 2, 1], [oConeheadZombie, 2, 1], [oNewspaperZombie, 2, 1], [oFootballZombie, 4, 1, [1]], [oBalloonZombie, 2, 1]],
  FlagNum: 7,
  FlagToSumNum: {
    a1: [3, 5],
    a2: [2, 8, 12]
