...
oS.Init({
  ...
  ZName: [oZombie, oConeheadZombie, oStrollZombie, oCrystal],
  PicArr: ["images/interface/ForestJx.webp"],
  backgroundImage: "images/interface/ForestJx.webp",
  LevelName: $__language_Array__["d2ffeb7c09acefe3b8e4f4c0bc72c6a0"],
  LvlEName: 6,
  ...
  SunNum: 200,
  StartGame: function () {
    PlaceZombie(oCrystal, 1, 8);
    oSym.addTask(70, PlaceZombie, [oCrystal, 3, 8]);
    StopMusic();
  ...
  AZ: [[oZombie, 3, 1], [oConeheadZombie, 2, 1], [oStrollZombie, 1, 4]],
  FlagNum: 5,
  FlagToSumNum: {
    a1: [1, 3, 4],
    a2: [1, 2, 8, 15]
