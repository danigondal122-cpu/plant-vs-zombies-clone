...
oS.Init({
  ...
  ZName: [oZombie, oNewspaperZombie, oConeheadZombie, oCrystal],
  PicArr: ["images/interface/ForestJx.webp"],
  backgroundImage: "images/interface/ForestJx.webp",
  LevelName: $__language_Array__["a591fb125fa08b47af40216f7ceba8f2"],
  LvlEName: 6,
  ...
  AZ: [[oZombie, 4, 1, [1]], [oNewspaperZombie, 4, 4, [4]], [oConeheadZombie, 4, 3]],
  FlagNum: 6,
  FlagToSumNum: {
    a1: [2, 3, 5],
    a2: [1, 2, 6, 10]
