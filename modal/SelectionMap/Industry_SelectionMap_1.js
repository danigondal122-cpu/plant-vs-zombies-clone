...
oSelectionMap.loadPage({
  ...
  LoadAccess($c, $box) {
    ...
    loadRes({
      img: [RESPATH + 'Industry', RESPATH + 'Industry_Mask.png', path + 'Plantern.webp', path + 'Cabbage.webp', RESPATH + 'IndustryClue1_1.webp', RESPATH + 'IndustryClue1_2.webp', RESPATH + 'IndustryClue1_3.webp', path + 'SculptorZombie.webp', ...oSculpture.prototype.PicArr]
    });
